...
const messages = {
    en: {
        ...
        help: '<b>✨ How it works</b>\n\n1. Send an audio file.\n2. Add a caption right away, send it as the next message, or convert without one.\n3. Edit the caption with the button under the voice message.\n4. Remove buttons before forwarding.\n\nUse /cancel to stop the current action. Use /balance to check your limits and /buy to get more conversions.',
        ...
        processingDownload: '⬇️ <b>Downloading audio...</b>',
        processingConvert: '🎛 <b>Converting audio...</b>',
        processingSend: '📤 <b>Sending voice message...</b>',
        ...
        noPendingAction: 'Nothing to cancel.',
        actionExpired: 'This action has expired.',
        cancelled: 'Cancelled.',
        convertWithoutCaptionButton: 'Convert without caption',
        cancelButton: 'Cancel',
    ...
    ru: {
        ...
        help: '<b>✨ Как это работает</b>\n\n1. Отправь аудиофайл.\n2. Добавь подпись сразу, отправь ее следующим сообщением или конвертируй без подписи.\n3. Измени подпись кнопкой под voice-сообщением.\n4. Убери кнопки перед пересылкой.\n\n/cancel отменит текущее действие. /balance покажет лимиты, /buy купит дополнительные конвертации.',
        ...
        processingDownload: '⬇️ <b>Скачиваю аудио...</b>',
        processingConvert: '🎛 <b>Конвертирую аудио...</b>',
        processingSend: '📤 <b>Отправляю voice...</b>',
        ...
        noPendingAction: 'Нечего отменять.',
        actionExpired: 'Это действие уже устарело.',
        cancelled: 'Отменено.',
        convertWithoutCaptionButton: 'Конвертировать без подписи',
        cancelButton: 'Отмена',
